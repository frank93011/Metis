...
function createUser(data) {
    return __awaiter(this, void 0, void 0, function* () {
        let newUser = typeorm_1.getRepository(user_1.User).create(data);
        return yield typeorm_1.getRepository(user_1.User).save(newUser);
    });
}
